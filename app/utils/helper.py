...
#         df['Volume Change'] = ta.ROC(df['volume'].values, timeperiod=1).round(2)
#
...
#
#     df_final_values.sort_values(by='Volume Change', ascending=False, inplace=True)
...
#
#     # Log and return top 3 coins with highest volume change
#     return df_final_values[
#         ['symbol', 'Volume Change', 'volume', 'close', 'pivot_point', 'r1', 's1', 'r2', 's2', 'r3', 's3',
#          'ema_9']].to_json(orient='records')
